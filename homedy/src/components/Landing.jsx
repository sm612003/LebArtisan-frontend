...
const Landing = ({ setSelectedPage }) => {
  ...
  return (
    <section
      id="home"
      className="md:flex md:justify-between md:items-center gap-16 md:h-full py-10 " style={{backgroundColor:'#8B8B8B',marginTop: '32px' }}
    >
      {/* IMAGE SECTION */}
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          ...
          before:w-full before:max-w-[400px] md:before:max-w-[600px] before:h-full before:border-2 before:border-0E4D4F before:z-[-1]"

          >
          <img
  alt="profile"
  className="transition duration-500 z-10 w-full max-w-[400px] md:max-w-[600px] border border-blue border-t-0 border-l-0 border-r-0 rounded-t-[400px]"
  src={img}
/>
  ...
  your gateway to discovering and supporting the rich tapestry of Lebanese craftsmanship. At LebArtisan Connect, we are passionate about celebrating the creativity, skill, and cultural heritage of local artisans across Lebanon."
      ...
      style={{ backgroundColor: '#70908B', marginLeft: '290px', textDecoration: 'none', color:'white' }}
